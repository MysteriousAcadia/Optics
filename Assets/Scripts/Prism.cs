...
public class Prism : MonoBehaviour
{
    ...
    public void Toggle(){
    if(isToggle){
        if(emergentLine!=null &&refractedLines!=null){
            // foreach
        }
    }
    else{
        if(refractedLinesGameO!=null){
            foreach(GameObject o in refractedLinesGameO){
                Destroy(o);
            }
            refractedLinesGameO = null;
        }
    }
    }
    ...
    public void Calculation(LineEquation line1, LineEquation line2, List<LineEquation> prismLineEquations)
    {
        ...
        {/*// Variables of use:
            ...
            LineEquation l1 = new LineEquation(Point1,Point2);
                        RefractedLine.Point2 = new Vector3((line2.Point2.y*RefractedLine.b-RefractedLine.c)/RefractedLine.a,-line2.Point2.y,RefractedLine.Point2.z);

            // drawLine.drawLine(l1);
            drawLine.drawLine(RefractedLine);
        }
        else if (!TIR3)
        {/*// Variables of use:
            Point1;
